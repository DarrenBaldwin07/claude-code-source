 ...
 */
export function formatPrompt(template, values, defaults = {}) {
 ...
 */
export function usePromptTemplate(templateName, values) {
 ...
 */
export function createConversation(prompt, system) {
    const messages = [];
 ...
 */
export function createFileContextMessage(filePath, content, language) {

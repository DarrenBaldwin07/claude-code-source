...
import { DEFAULT_OAUTH_CONFIG, performOAuthFlow, refreshOAuthToken, } from "./oauth.js";
import { createTokenStorage, isTokenExpired, validateToken, getTokenDetails, createAuthorizationHeader, } from "./tokens.js";
...
export class AuthManager {
    ...
    async checkAndRefreshToken() {
        ...
        if (this.state.method !== AuthMethod.OAUTH ||
    ...
    async refreshToken() {
        ...
        try {
            ...
            const newToken = await refreshOAuthToken(this.state.token.refreshToken, oauthConfig);
 ...
 */
export async function initAuthentication(config = {}) {
        ...
        return {
            ...
            authenticate: async (options = {}) => {
                const method = options.method ||
                    authManager.getAuthMethod() ||
                    DEFAULT_AUTH_CONFIG.preferredMethod;
